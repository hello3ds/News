...
/// emoji 宽度
let emojiItemWitdh = screenWidth / 7


/// 服务器地址
//let BASE_URL = "http://lf.snssdk.com"
//let BASE_URL = "http://ib.smssdk.com"
...
let topTabinddicatorWidth:CGFloat = 40
let topTabindicatorHeight:CGFloat = 2

let MyPresentationControllerDismiss = "MyPresentationControllerDismiss"
let NavigationBarConcernButtonClicked = "NavaigationBarConcernButtonClicked"
